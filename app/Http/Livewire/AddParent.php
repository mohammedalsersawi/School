        ...
        try {
            ...
            if (!empty($this->photos)) {
                foreach ($this->photos as $photo) {
                    $file_name =  Str::random(40) . '_' . $photo->getClientOriginalName();

                    $photo->storeAs($this->National_ID_Father, $file_name, $disk = 'parent_attachments');

                    $My_Parent->attachments()->create([
                        'file_name' => $file_name,
